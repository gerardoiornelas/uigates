 ...
 * the engine (which gates a proposal by its declared resource) and `uigates audit` (which checks the
 ...
 * A resource of `.` or `/` names no particular file and is not matched here; `uigates audit` is what
