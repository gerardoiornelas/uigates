...
Apply UI-GATES: ground work in committed knowledge; bound intent and authority; propose consequential actions before execution; execute only delegated work; verify with evidence; record a receipt; and promote only warranted, provenance-backed learning.
